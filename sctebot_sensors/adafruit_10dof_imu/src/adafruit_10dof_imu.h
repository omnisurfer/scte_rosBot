...
public:
    ...
    void run() {
        ...
        l3gd20GyroDeviceHandle->init_device(
                L3gd20Gyro::OutputDataRates::ODR_12P5HZ, //ODR_12P5HZ_BM,
        ...
        lsm303DlhcAccelDeviceHandle->init_device(
                Lsm303DlhcAccelerometer::OutputDataRates::ODR_10P0HZ, //ODR_1P0HZ,
        ...
        lsm303DlhcMagDeviceHandle->init_device(
                Lsm303DlhcMagnetometer::OutputDataRates::ODR_7P5_HZ, //ODR_1P5_HZ,
